...
<div class="flex flex-col items-center justify-center">
	...
	<div class="space-y-5 max-w-3xl text-lg">
		<p>
			<strong>🚀 Launch Phase:</strong> Strap in and prepare for lift-off! Click 'Login' on the top right
			to activate your mission control center.
		</p>
		<p>
			<strong>🌌 Exploration Phase:</strong> Set your trajectory! Head over to your 'Courses' tab. This
			is your star map, guiding you through classes and showing what galaxies remain unexplored.
		</p>
	</div>
